...
class PlayState extends MusicBeatState
{
	...
	private var cryingchild:CryingChild;
	...
	override public function create()
	{
		...
		switch(SONG.song.toLowerCase())
		{
			case 'funtime' | 'broken' | 'no-more-hiding': 
			{
			curStage = "spooky";
			halloweenLevel = true;
			...
			halloweenBG = new FlxSprite(-600, -400);
			halloweenBG.frames = hallowTex;
			halloweenBG.animation.addByPrefix('idle', 'halloweem bg lightning strike0014');
